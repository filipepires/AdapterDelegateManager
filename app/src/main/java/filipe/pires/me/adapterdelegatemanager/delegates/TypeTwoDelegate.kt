...
import kotlinx.android.synthetic.main.delegate_type_two.view.*


class TypeTwoDelegate(private val viewType: Int) : AdapterDelegate {
    ...
    override fun onCreateViewHolder(parent: ViewGroup): AdapterDelegate.ViewHolderDelegate {
        ...
        val view = inflater.inflate(R.layout.delegate_type_two, parent, false)
